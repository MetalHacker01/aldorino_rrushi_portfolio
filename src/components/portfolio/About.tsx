      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Skills - Use AboutCopy look/feel but About text/order */}
            <div className="scroll-reveal">
              <h3 className="text-2xl font-semibold mb-6 text-primary">Core Expertise</h3>
              <div className="grid gap-4">
                <div className="flex flex-col gap-4">
                  <div className="flex flex-col gap-2">
                    <h4 className="text-xl font-semibold mb-2 text-primary">Marketing Automation Platforms</h4>
                    {["Salesforce Marketing Cloud", "Oracle Eloqua", "Adobe Marketo", "Oracle Responsys", "HCL Unica"].map((platform, idx) => (
                      <div
                        key={platform}
                      ...
                      >
                        ...
                        <span className="text-lg font-medium group-hover:text-primary transition-smooth">{platform}</span>
                      </div>
                    ))}
                  </div>
                  <div className="flex flex-col gap-2 mt-6">
                    <h4 className="text-xl font-semibold mb-2 text-primary">Development Languages</h4>
                    {["HTML/CSS/JavaScript", "SQL & Data Segmentation", "AmpScript & SSJS", "Python & APIs"].map((lang, idx) => (
                      <div
                        key={lang}
                        className="flex items-center space-x-4 p-4 bg-gradient-card rounded-lg border border-border hover:border-primary/50 transition-smooth group"
                      ...
                      >
                        <div className="w-2 h-2 bg-primary rounded-full group-hover:shadow-glow transition-smooth"></div>
                        <span className="text-lg font-medium group-hover:text-primary transition-smooth">{lang}</span>
                      </div>
                    ))}
                  </div>
                </div>
