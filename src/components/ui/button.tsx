...
const buttonVariants = cva(
  ...
  hero: "bg-gradient-primary text-primary-foreground shadow-button hover:shadow-glow transform hover:scale-105 transition-bounce hover:text-white",
        terminal: "bg-card border border-border text-foreground font-mono hover:bg-muted/50",
      },
      size: {
